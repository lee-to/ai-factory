...
| `aif-plan`         | `paths.plan`, `paths.plans/<id>.md`, `paths.plans/<id>/index.md` + linked phase files                   | `.ai-factory/DESCRIPTION.md`, `.ai-factory/ARCHITECTURE.md`, `.ai-factory/RESEARCH.md`                                                                | `aif-improve` may refine existing plan files or complete ultra bundles                                                                                                 |

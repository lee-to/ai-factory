...
| `/aif-qa-check`                           | `paths.qa/<branch-slug>/qa-check.md`, `paths.qa/<branch-slug>/browser-replay/`, `paths.qa/agent-context.md`, `paths.qa/agent-history.md` | executes `/aif-qa` test cases; replay scripts avoid regenerating browser automation; source QA artifacts stay read-only |

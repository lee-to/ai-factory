...
| `/aif-plan full` | `paths.plans/<branch-or-slug>.md` (default) | Keep (user decides) |
| `/aif-plan full` (`workflow.plan_id_format: sequential`) | `paths.plans/<NNNN>_<branch-or-slug>.md` (4-digit, monotonic) | Keep (user decides) |

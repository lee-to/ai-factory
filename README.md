...
- **Multi-agent support** — Claude Code, Cursor, Windsurf, Roo Code, Kilo Code, Antigravity, OpenCode, Warp, Zencoder, Codex CLI, Codex app, GitHub Copilot, Gemini CLI, ChatGPT CLI, OpenRouter CLI, Junie, Qwen Code, or [any agent](docs/getting-started.md#supported-agents)
